...
class SecondViewController: UIViewController {
    ...
    private var questionController : PunJokeContrller!
    private var punchlineController : PunPunchlineContrller!
    
    private func firstBuilder() {
        if questionController == nil {
            questionController = storyboard?.instantiateViewControllerWithIdentifier("PunQuestion") as! PunJokeContrller
        }
    }
    
    private func secondBuilder() {
        if punchlineController == nil {
            punchlineController = storyboard?.instantiateViewControllerWithIdentifier("PunPunchline") as! PunPunchlineContrller
        }
    }
